.data
    ...
    id_invalido: .asciiz "\nID invalido!\n"
    qtd_invalida: .asciiz "\nQuantidade invalida! Digite entre 1 e 20.\n"
    ...
    # Arrays para armazenar compras
    ids_carrinho: .word 0:20
    qtds_carrinho: .float 0:20  #
...
pagamento_loop:
    ...
    # Arredonda troco para duas casas decimais
    l.s $f5, const_100  
    mul.s $f12, $f12, $f5 
    round.w.s $f12, $f12 
    cvt.s.w $f12, $f12
